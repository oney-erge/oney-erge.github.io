...
export const projects: Project[] = [
  {
    ...
    headline: "A local agent you can safely let act.",
    description:
      "Reach it from the web, Telegram, or WhatsApp. Every task moves through plan, approve, execute, verify, and receipt, with policy enforced at each tool call.",
    proof: "Local-first · 12 model providers · Auditable task receipts",
    tags: ["Python", "FastAPI", "React", "Agents"],
    visual: "ybm",
  ...
  },
  {
    ...
    headline: "Full-precision models beyond VRAM.",
    description:
      "Losslessly compresses and streams BF16 weights so a 29.5 GB model can run on an 8 GB GPU without quantization.",
    proof: "Measured reference run · CLI, web UI, and OpenAI-compatible API",
    tags: ["PyTorch", "CUDA", "Inference", "Python"],
    visual: "afterimage",
    image: "/media/afterimage-logo.webp",
    ...
    question:
      "How can a full-precision language model run when its original checkpoint is much larger than GPU memory?",
    overview: [
      "Afterimage compresses model weights losslessly and streams them through the GPU one layer at a time. It is intended for research, evaluation, and offline generation where preserving the original BF16 checkpoint matters more than chat-speed latency.",
    ...
    workflow: [
      ...
      { label: "Compress", detail: "Build a lossless on-disk store from the original checkpoint." },
    ...
    evidence: [
      "A 29.536 GB Qwen3-14B BF16 checkpoint ran on an 8 GB RTX 3080 Laptop GPU.",
      "The measured fixed-speculation point used 3.813 GB peak VRAM at 9.150 seconds per token.",
      "The lossless store reduced the reference checkpoint to 20.328 GB, a 1.453x reduction.",
    ],
    limits:
  ...
  },
  {
    ...
    headline: "Choose the right local model for the hardware you have.",
    description:
      "Detect hardware, estimate model fit, deploy a local runtime, and compare quality, latency, throughput, and memory from one interface.",
    proof: "Windows, macOS, Linux, and Docker · Published on PyPI",
    tags: ["Python", "Ollama", "Benchmarking", "Local models"],
    visual: "localdeploy",
  ...
  },
  {
    ...
    headline: "Agents build, test, and revise inside simulated worlds.",
    description:
      "A visual physics sandbox with validated tools, replayable attempts, explainable scores, and reproducible experiment matrices.",
    proof: "24 explicit tools · Durable traces · Paired model experiments",
    tags: ["Agents", "Physics", "Evaluation"],
    visual: "agentarium",
  ...
  },
  {
    ...
    headline: "Find out why a robot experiment failed.",
    description:
      "Design a body, run it in physics, isolate the failure, and share the exact creature, task, controller, trace, and runtime evidence.",
    proof: "Offline · Reproducible experiment packs · PyBullet",
    tags: ["Robotics", "Simulation", "Python"],
    visual: "creature",
  ...
  },
  {
    ...
    headline: "One configuration from training to video inference.",
    description:
      "A config-first semantic segmentation toolkit that keeps training, evaluation, image and video prediction, and the optional web app aligned.",
    proof: "Reusable YAML workflows · CLI, Python API, and web app",
    tags: ["PyTorch", "Vision", "FastAPI"],
    visual: "segcraft",
    image: "/media/segcraft-preview.webp",
